...
public class XxlJobServiceImpl implements XxlJobService {
    ...
    private void validateParams(HandleShardingParam handleShardingParam) {
        ...
        if (handleShardingParam.getIsAutomatic() == 1) {
            // 校验调度周期
    ...
    private XxlJobInfo buildXxlJobInfo(HandleShardingParam handleShardingParam, XxlJobGroup xxlJobGroup) {
        ...
        xxlJobInfo.setId(IdUtil.getSnowflakeNextId());
        xxlJobInfo.setRemoteId(handleShardingParam.getId());
        ...
        xxlJobInfo.setTriggerNextTime(handleShardingParam.getIsAutomatic() == 1 ? TimeConverterUtil.convertToTimestamp(handleShardingParam.getFirstSchedulingTime()) : 0);
        ...
        xxlJobInfo.setSchedulingCycle(handleShardingParam.getIsAutomatic() == 1 ? handleShardingParam.getSchedulingCycle().name() : null);
    ...
    private List<XxlJobShardingInfo> buildXxlJobShardingInfos(
        ...
        for (TimeRange timeRange : timeRanges) {
            ...
            xxlJobShardingInfo.setTriggerTime(handleShardingParam.getIsAutomatic() == 1
                    ...
                    : new Date());
            xxlJobShardingInfo.setIsAutomatic(handleShardingParam.getIsAutomatic());
