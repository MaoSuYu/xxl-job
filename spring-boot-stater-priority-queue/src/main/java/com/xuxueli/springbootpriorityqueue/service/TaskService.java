...
public class TaskService {
    ...
    private final RedisPriorityQueue<Task> taskQueue;
    
    public TaskService(RedisPriorityQueueFactory queueFactory) {
        // 获取或创建一个Task类型的优先级队列
        this.taskQueue = queueFactory.getQueue("tasks", Task.class);
    }
